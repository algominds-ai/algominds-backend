/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b6de0a8af031624e14f1ac566714bda2)
...
interface __BaseEnv_Env {
	...
	EVAL_API_KEY_MSTONE: string;
	EVAL_API_KEY_FORM3: string;
	EVAL_API_KEY_ARIS: string;
	EVAL_API_KEY_CARTA: string;
	BRAINTRUST_API_KEY: string;
	EVAL_API_KEY_ONDATO: string;
