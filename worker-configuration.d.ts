/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 386b6c11b9c42aefb721c16b0a84242f)
...
interface __BaseEnv_Env {
	...
	APOLLO_API_KEY: SecretsStoreSecret;
	FINDYMAIL_API_KEY: SecretsStoreSecret;
	CF_AIG_TOKEN: SecretsStoreSecret;
	API_BEARER_TOKEN: SecretsStoreSecret;
	...
	FIND_COMPANIES: Workflow<Parameters<import("./src/index").FindCompaniesWorkflow['run']>[0]['payload']>;
	FIND_PEOPLE: Workflow<Parameters<import("./src/index").FindPeopleWorkflow['run']>[0]['payload']>;
	ENRICH: Workflow<Parameters<import("./src/index").EnrichWorkflow['run']>[0]['payload']>;
	ONBOARD_ICP: Workflow<Parameters<import("./src/index").OnboardIcpWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "AI_GATEWAY_BASE_URL" | "CF_ACCOUNT_ID" | "CF_GATEWAY_ID" | "MODEL_ROUTE_REASONING" | "MODEL_ROUTE_WORKER" | "CF_AIG_TOKEN" | "OPENROUTER_API_KEY" | "EXA_API_KEY" | "BRIGHTDATA_API_TOKEN" | "CLAY_API_KEY" | "TREG_API_KEY" | "APOLLO_API_KEY" | "FINDYMAIL_API_KEY" | "DATABASE_URL" | "PORT" | "API_BEARER_TOKEN">> {}
}
