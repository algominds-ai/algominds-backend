...
const SYNTHESIZE_INSTRUCTIONS = [
	...
	"that caused it leaves the profile's own window. The code turns your number into the two",
	"dates it means, demands them of the search, and refuses a page older than that. A page carrying no date still",
