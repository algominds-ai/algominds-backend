...
const JUDGE_INSTRUCTIONS = [
	...
	'still operates; a word like "partners" alone does not disqualify a row, and a note of an',
	"acquisition or a shutdown counts against a requirement only where that requirement",
	"excludes it.",
